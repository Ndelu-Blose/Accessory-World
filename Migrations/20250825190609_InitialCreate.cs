        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseTradeInValue = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DeviceBrand = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    EvaluationMethod = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CustomerNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    OfferAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TradeInCases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TradeInCases_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomUserRoles_AspNetUsers_AssignedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FulfilmentMethod = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    CreditNoteAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "TradeInEvaluations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TradeInCaseId = table.Column<int>(type: "int", nullable: false),
                    EvaluatedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ScreenCondition = table.Column<int>(type: "int", nullable: false),
                    BodyCondition = table.Column<int>(type: "int", nullable: false),
                    BatteryHealth = table.Column<int>(type: "int", nullable: false),
                    FunctionalityScore = table.Column<int>(type: "int", nullable: false),
                    HasOriginalBox = table.Column<bool>(type: "bit", nullable: false),
                    HasCharger = table.Column<bool>(type: "bit", nullable: false),
                    HasEarphones = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    ConditionAdjustment = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    AccessoryBonus = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    FinalOfferAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    EvaluatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TradeInEvaluations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TradeInEvaluations_AspNetUsers_EvaluatedByUserId",
                        column: x => x.EvaluatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TradeInEvaluations_TradeInCases_TradeInCaseId",
                        column: x => x.TradeInCaseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TradeInImages_TradeInCases_TradeInCaseId",
                        column: x => x.TradeInCaseId,
                        principalTable: "TradeInCases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreditNoteCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TradeInCaseId = table.Column<int>(type: "int", nullable: true),
                    ...
                    ConsumedInOrderId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CreditNotes_Orders_ConsumedInOrderId",
                        column: x => x.ConsumedInOrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CreditNotes_TradeInCases_TradeInCaseId",
                        column: x => x.TradeInCaseId,
                        principalTable: "TradeInCases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedByStaffId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PickupOTPs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PickupOTPs_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RMAs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RMAItems_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RMAItems_RMAs_RMAId",
                        column: x => x.RMAId,
                        principalTable: "RMAs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditNotes_ConsumedInOrderId",
                table: "CreditNotes",
                column: "ConsumedInOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditNotes_CreditNoteCode",
                table: "CreditNotes",
                column: "CreditNoteCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CreditNotes_TradeInCaseId",
                table: "CreditNotes",
                column: "TradeInCaseId",
                unique: true,
                filter: "[TradeInCaseId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomUserRoles_AssignedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RMAItems_OrderItemId",
                table: "RMAItems",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_RMAItems_RMAId",
                table: "RMAItems",
                column: "RMAId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TradeInCases_CaseNumber",
                table: "TradeInCases",
                column: "CaseNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TradeInCases_IMEI",
                table: "TradeInCases",
                column: "IMEI");

            migrationBuilder.CreateIndex(
                name: "IX_TradeInCases_UserId",
                table: "TradeInCases",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TradeInEvaluations_EvaluatedByUserId",
                table: "TradeInEvaluations",
                column: "EvaluatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TradeInEvaluations_TradeInCaseId",
                table: "TradeInEvaluations",
                column: "TradeInCaseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TradeInImages_TradeInCaseId",
                table: "TradeInImages",
                column: "TradeInCaseId");
        }
