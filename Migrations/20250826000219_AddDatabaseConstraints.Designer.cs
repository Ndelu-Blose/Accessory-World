...
namespace AccessoryWorld.Migrations
{
    ...
    [Migration("20250826000219_AddDatabaseConstraints")]
            ...
            modelBuilder.Entity("AccessoryWorld.Models.TradeInEvaluation", b =>
                {
                    ...
                    b.ToTable("TradeInEvaluations", t =>
                        {
                            t.HasCheckConstraint("CK_TradeInEvaluation_EstimatedValue_NonNegative", "[EstimatedValue] >= 0");

                            t.HasCheckConstraint("CK_TradeInEvaluation_FinalValue_NonNegative", "[FinalValue] >= 0");
                        });
                });
